		...
		<div class="card">
			...
			<div class="card-body">
				<form id="formTahunAjaran">
					<input type="hidden" name="id" @isset($tahun_ajaran) value="{{$tahun_ajaran->id_tahun_ajaran}}" @endisset>
					<div class="mb-3">
						<label for="judul" class="form-label">Tahun Ajaran *</label>
						<input type="text" class="form-control" name="judul" id="judul" placeholder="Judul Materi" @isset($tahun_ajaran) value="{{$tahun_ajaran->nama_tahun_ajaran}}" @endisset>
					</div>
					<hr>
...
<script>
	...
	$('.btnSimpan').click((e) => {
		e.preventDefault()
		var data = new FormData($('#formTahunAjaran')[0])
