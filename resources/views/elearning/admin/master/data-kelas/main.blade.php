...
<script>
	var routeDatatable = "{{route('elearning.dataKelas.main')}}";
	var routeDataKelasAdd = "{{route('elearning.dataKelas.add')}}";
	var routeDataKelasDelete = "{{route('elearning.dataKelas.add')}}";
	...
	async function dataTable() {
		...
		const templateTambah = `
			<button onclick="tambahDataKelas()" class='btn btn-primary p-2 w-100'><i class='bx bx-plus' ></i>Tambah</button>
		`;
