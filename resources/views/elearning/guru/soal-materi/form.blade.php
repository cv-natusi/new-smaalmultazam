			...
			<div class="card-body">
				<form id="formMateri">
					...
					<div class="row">
						...
						<div class="col-4">
							<div class="mb-3">
								<label for="kkm" class="form-label">Tanggal Mulai *</label>
								<input class="form-control mb-2" type="date" name="" id="">
								<input class="form-control" type="time" name="" id="">
							</div>
						</div>
						<div class="col-4">
							<div class="mb-3">
								<label for="kkm" class="form-label">Tanggal Selesai *</label>
								<input class="form-control mb-2" type="date" name="" id="">
								<input class="form-control" type="time" name="" id="">
							</div>
						</div>
						<div class="col-2">
							<div class="mb-3">
								<label for="kkm" class="form-label">Jumlah Soal *</label>
								<input class="form-control" type="text" name="" id="">
							</div>
						</div>
						<div class="col-2">
							<div class="mb-3">
								<label for="kkm" class="form-label">Durasi Pengerjaan *</label>
								<input class="form-control" type="text" name="" id="">
							</div>
						</div>
					</div>
					...
					<div class="d-flex gap-2">
						...
						<button class="btn btn-primary px-4 btnSimpan">BUAT SOAL</button>
					</div>
				</form>
			</div>
		</div>
