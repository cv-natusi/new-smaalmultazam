...
@push('script')
	...
	<script>
		var routeDatatable = "{{route('main.menuUtama.beritaSekolah.main')}}"
		var routeBeritaAdd = "{{route('main.menuUtama.beritaSekolah.add')}}"
		var routeBeritaDelete = "{{route('main.menuUtama.beritaSekolah.delete')}}"
		var routeBeritaAktif = "{{route('main.menuUtama.beritaSekolah.aktif')}}"
	</script>
@endpush