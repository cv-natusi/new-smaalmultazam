	...
	<div class="col-sm-12">
		<div class="card main-page">
			<div class="card-body">
				<div class="row mb-3">
					<div class="col-md-3">
						<button type="button" class="btn btn-primary" onclick="tambahPengumuman()"><i class='bx bx-plus'></i>Tambah Baru</button>
					</div>
				</div>
				<div class="p-1">
					<table class="table-responsive table table-striped table-bordered stripe row-border order-column" style="width:100%" id="dataTable">
						...
						<tbody>
							<tr>
								...
								<td>SMAS Al-Multazam Borong Juara Olimpiade Bahasa Arab</td>
								<td>Aktif</td>
								<td>
...
@push('script')
	...
	<script src="{{asset('admin/content/js/main-pengumuman.js')}}"></script>
	<script src="{{asset('zoom/js/jquery.pan.js')}}"></script><!--zoomImage-->
	<!--Sweetalert -->
	<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	<script>
		var routeDatatable = "{{route('main.menuUtama.pengumuman.main')}}"
		var routeBeritaAdd = "{{route('main.menuUtama.pengumuman.add')}}"
		var routeBeritaDelete = "{{route('main.menuUtama.pengumuman.delete')}}"
		var routeBeritaAktif = "{{route('main.menuUtama.pengumuman.aktif')}}"
	</script>
@endpush