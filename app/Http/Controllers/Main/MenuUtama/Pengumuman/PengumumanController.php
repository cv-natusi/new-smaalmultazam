...
namespace App\Http\Controllers\Main\MenuUtama\Pengumuman;
...
class PengumumanController extends Controller
{
	public function main(Request $request) {
		...
		if ($request->ajax()) {
			return DataTables::of($data)->
				...
				addColumn('actions',function($row){
					$html = "<button onclick='tambahPengumuman($row->id_berita)' class='btn btn-dark btn-purple p-2'><i class='bx bx-edit-alt mx-1'></i></button>";
					if ($row->status) {
		...
		return view('main.content.pengumuman.main',$data);
	}
